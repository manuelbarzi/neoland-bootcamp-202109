...
//Declaro un esquema (acción) porque veo la palabra function
//Este esquema lo llamo hiFriends porque me encuentro este nombre entre function y ()
//Este esquema tiene un parámetro dentro del paréntesis que veo que necesita que realice una acción
//Al ver "{" significa que abro la caja donde están las cosas que necesito para hacer la acción según el esquema
//Guardo un espacio porque encuentro la palabra reservada "var"
//Este espacio se va a llamar "hello" porque encuentro este nombre entre "var" y "=" (ósea despues de "var")
//En el espacio en el que guardé "hello", guardo la información "Hello" por que está dentro de "=" y ";"
//Al ver la palabra "for" entro en un bucle
//Al entrar al bucle enuentro 3 herramientas: 
                                            //1 contador a 0 porque "var i = 0", 
                                            //un stopper que es "i <friends.lenght -1 === i"
                                            //
