...
// En este bucle entro con 3 herramientas, un contador a 0 porque "var i = 0", un stopper que es "i < friends.length" y un temporizador
// que aumenta 1 mi contador porque "i++"
// Por cada vuelta de bucle voy a hacer 3 tareas a mas a mas dentro del bucle nos encontramos dos condiciones que vienen descritas por if y por else.
// If es una condiciones cuando se cumple true se ejecuta y else tambien es una condición que se cumple false y se ejecuta.
// En este tenemos que tener en cuenta los condicionales para que se pueda ejecutar correctamente.
// 1- En la primera vuelta: 
// - Comprobamos si "i < friends.length" 
// - Recordamos el valor de i que es 0, Recordamos el valor de friends.length que en el ejemplo es 3. 
// - Comprobamos la condición que es 0 < 3 "i < friends.length" si es true seguimos si no nos salimos del bucle.
// - entramos dentro de las dos condiciones en el que el if nos indica que si "friends.lenght-1 === i"  en el cual en este caso es 3 -1 ==== i.
// - como se no se cumple la condicion del if se pasa a la siguiente el else
//    