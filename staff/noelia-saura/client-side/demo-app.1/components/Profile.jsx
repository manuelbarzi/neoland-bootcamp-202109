class Profile extends React.Component{
    ...
    gotToUpdatePassword = ()=> this.setState({view:'update-password'})
    ...
    render(){
        ...
        {this.state.view === 'update-password' && <div className='profile container container-vertical'>
            ...
            {this.state.view==='unregister'&& <Unregister onBack={this.gotToUpdatePassword} onUnregister={this.props.onUnregister}/>}
            </>
    }
}