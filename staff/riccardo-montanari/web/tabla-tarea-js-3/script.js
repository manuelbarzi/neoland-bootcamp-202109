let compra = [
    {nombre: 'Pasta', cantidad: 3, precio: 7},
    {nombre: 'Solomillo', cantidad: 5, precio: 3} ,
    {nombre: 'Manzana', cantidad: 2, precio: 8 },
    {nombre: 'Dorada', cantidad: 5, precio: 3}
];
