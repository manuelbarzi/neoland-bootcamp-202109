...
describe.only('registerProperty', () => {
    ...
    // beforeEach(async () => await Promise.all([User.deleteMany(), Property.deleteMany()]))

    // beforeEach(() => User.deleteMany().then(() => Property.deleteMany())) // WARN not the same as previous
    // beforeEach(async () => {
