const calcPopulation = (natalidad, inmigracion, mortalidad, ayosEstimados, poblacionActual) => {
  // var nacidos = poblacionActual + %natalidad
	// var crecimientoInmig = nacidos + inmigrantes
	// var descreMortal = crecimientoInmig - mortalidad

	for (let i = 0; i < ayosEstimados; i++) {
		var nacidos = poblacionActual * natalidad / 100;
		poblacionActual += nacidos + inmigracion - mortalidad;    
	}
