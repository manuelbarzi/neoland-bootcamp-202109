...
/*
3- Analiza tu comentario e identifica qué parámetros deberá recibir la función para poder empezar a funcionar, y escribe esos parámetros dentro del paréntesis que sigue al nombre de la función.
...
*/
/*
4- Analiza tu comentario de nuevo e identifica ahora qué deberá devolver como resultado final tu función una vez que haya hecho su trabajo, y escribe ese resultado dentro de la función de forma provisional. En muchas ocasiones se suele definir al principio de la función una variable en la que se guardará el valor del resultado final. Algo así:
var nombreDeLaVariable = valorInicialDeLaVariable
Si ves apropiado usar en tu función una variable con este propósito, entonces quizá podrías escribir ya también la expresión final de tu función, que será en muchas ocasiones algo así:
