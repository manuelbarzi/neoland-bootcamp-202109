...
function scrapeZaraKids() {
    return (async () => {
        try {
            await scrapeCollection( {
                url: 'https://www.zara.com/es/es/search?searchTerm=join%20life&section=KID',
            ...
            logger.debug('end scraping Zara Kids Collection')
        } catch (error) {
            logger.error(error)
        }
    })()
