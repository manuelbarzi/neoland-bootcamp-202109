...
function scrapeZaraMan() {
    return (async () => {
        try {
            await scrapeCollection( {
                url: 'https://www.zara.com/es/es/search?searchTerm=join%20life&section=MAN',
            ...
            logger.debug('end scraping Zara Man Collection')
        } catch (error) {
            logger.error(error)
        }
    })()
