...
function Home({ Username, OnSignOut, OnDelete, OnStartFlow, OnEndFlow, OnShowModal }) {
    ...
    return <div className="pagelayout">
        ...
        {view === 'home' && <>
            ...
            {query && !vehicleId && <Results query={query} onItem={goToDetail} OnStartFlow={OnStartFlow} OnEndFlow={OnEndFlow} OnShowModal={OnShowModal} ></Results>}
            {vehicleId && <Detail itemid={vehicleId} OnBackList={() => setvehicleId(null)} OnStartFlow={OnStartFlow} OnEndFlow={OnEndFlow} OnShowModal={OnShowModal} ></Detail>}
