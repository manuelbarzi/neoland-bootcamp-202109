function calcPopulation(natalidad, inmigracion, mortalidad, añosEstimados, poblacionActual) {

    var copyPoblacion = poblacionActual

    for (let i = 0; i < añosEstimados; i++) {
        copyPoblacion += (copyPoblacion * natalidad) / 100;
        copyPoblacion -=  mortalidad;
        copyPoblacion += inmigracion;
    }

    return Math.round(copyPoblacion)
} 
